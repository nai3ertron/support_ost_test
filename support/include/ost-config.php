...
define('SECRET_SALT','tN3Bjg0x8qB8cABudY1Egf7uZQ37NkJs');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','ruangry.warapong14310@gmail.com');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','ztidev.com:3306');
define('DBNAME','em');
define('DBUSER','em');
define('DBPASS','ZTIDEVzeal1tech');
